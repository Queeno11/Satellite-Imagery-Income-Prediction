...
def create_generators(
    ...
    test_generator = ImageDataGenerator(rescale=1.0 / 512)
...
def small_cnn() -> Sequential:
    ...
    model.add(layers.RandomCrop(224, 224, seed=1, input_shape=(512, 512, 3)))
...
def adapt_efficient_net() -> Model:
    ...
    croped_inputs = crop_inputs(456)(inputs)
    # use the downloaded and converted newest EfficientNet wheights
    model = EfficientNetB5(include_top=False, weights="imagenet")(croped_inputs)
