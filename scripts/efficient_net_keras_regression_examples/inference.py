...
model.load_weights("R:/Tesis Nico/Códigos/data/data_out/efficient_net_keras_regression/models/eff_net.h5")
images = open_images("R:/Tesis Nico/Códigos/data/data_out/efficient_net_keras_regression/inference_samples")

predictions = model.predict(images)

images_names = os.listdir("R:/Tesis Nico/Códigos/data/data_out/efficient_net_keras_regression/inference_samples")
